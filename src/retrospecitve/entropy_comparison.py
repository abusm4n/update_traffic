...
# Configuration
ENTROPY_DIR = os.path.expanduser("~/update_traffic/retrospective/entropy/selected10")
OUTPUT_DIR = os.path.expanduser("~/update_traffic/retrospective/analysis_output")
...
###############################################################################
    ...
    plt.tight_layout()
    plt.savefig(os.path.join(FIGURES_DIR, "entropy_boxplots_re.pdf"), dpi=300, bbox_inches='tight')
